...
<body>
<main>
    <h1 class="text-black-800 font-bold">{{ __('auth.identify_yourself')}}</h1>
    <form class="inline-block p-4 border-1" action="{{route('register.store')}}" method="post">
        @csrf
        <fieldset class="p-4">
            <label class="" for="email">
                {{ __('registerform.email')}}
            </label>
            <input class="border-1 rounded-sm" type="email" id="email" name="email">
            <label class="" for="password">
                {{ __('registerform.password')}}
            </label>
            <input class=" border-1 rounded-sm" type="password" id="password" name="password">
            <label class="" for="password">
                {{ __('registerform.password')}}
            </label>
            <input class=" border-1 rounded-sm" type="password" id="password" name="password">
        ...
        <div class="py-4">
            <input class="py-4" type="checkbox">{{__('registerform.remember_me')}}
            <a class="py-4 text-blue-800" href="/{{ route('register.store') }}">{{__('registerform.forgot_password')}}</a>
        </div>
        <button type="submit"
                class="flex items-center px-20 py-2 rounded-sm border-blue-4 bg-blue-950 text-blue-950 ...">{{__('registerform.log_in')}}</button>
    </form>
</main>
</body>
</html>
